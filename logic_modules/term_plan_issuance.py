...
TENANT_ID = ["MANAPPURAM", "POLICYBAZAAR", "SALES-APP", "BANDHANBANK", "ALLIANCE"]
...
BROKERS_DATA = [
    {"AgentCode": 10051410, "PartnerName": "MANAPPURAM", "AgentType": "BROKER", "Channel": "Non-Direct", "tenantID": "MANAPPURAM"},
    {"AgentCode": 10051368, "PartnerName": "POLICYBAZAAR", "AgentType": "BROKER", "Channel": "Direct", "tenantID": "POLICYBAZAAR"},
    {"AgentCode": 20000001, "PartnerName": "BANDHANBANK", "AgentType": "CORPORATE AGENT", "Channel": "Non-Direct", "tenantID": "BANDHANBANK"},
    {"AgentCode": 10051329, "PartnerName": "Alliance Broker", "AgentType": "BROKER", "Channel": "Non-Direct", "tenantID": "ALLIANCE"},
    {"AgentCode": 10008563, "PartnerName": "Direct Marketing E", "AgentType": "Direct Marketing E", "Channel": "Direct", "tenantID": "SALES-APP"}
]
...
column_order = [
    ...
    "FLC date", "Grace date", "Lapse date",
    "inceptionDate", "policyHolderLocation", "insurerLocation", "birthdate", "Age", "gender", "smoking", "Medicalindi",
    "productCode", "coverageYear", "chargeYear", "Premium Payment Option", "premiumPayOption", "Coverage upto Age", "PPT 60 Pay",
    ...
    "ADRiderVariantC", "Commission rate", "AgentCode", "PartnerName", "AgentType"
]
...
def calculate_commission_rate(ppt_name):
    if ppt_name == "Single Pay":
        base_rate = '5%'
    elif ppt_name == "Limited Pay (5 pay)":
        base_rate = '30%'
    else:
        base_rate = '70%'
    return base_rate
...
def build_common_row(tuid_counter, module_name, api_operation, checking_note, ppt_name, scenario_text, test_type,
    ...
    return {
        ...
        'PPT 60 Pay': '60' if ppt_name == "Limited Pay (Pay till age 60)" else 'NA',
        'chargePeriod': 2,
        ...
        'Channel': tenant_map.get(discount_info.get('tenantID'))['Channel'],
        ...
        'Commission rate': '0%' if(tenant_map.get(discount_info.get('tenantID'))['Channel']=='Direct') else calculate_commission_rate(ppt_name),
        'AgentCode': tenant_map.get(discount_info.get('tenantID'))['AgentCode'],
        'PartnerName': tenant_map.get(discount_info.get('tenantID'))['PartnerName'],
        'AgentType': tenant_map.get(discount_info.get('tenantID'))['AgentType'],
    }
